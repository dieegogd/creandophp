                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('articulo_id', App\Models\Articulo::orderBy('nombre')->pluck('nombre', 'id'), old('articulo_id', $listaprecio->articulo_id), ['class' => 'form-control']) }}
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
                                    <div class="form-group">
                                        <label for="localidad_id">Localidad:</label>
                                        {{ Form::select('localidad_id', App\Models\Localidad::orderBy('nombre')->pluck('nombre', 'id'), old('localidad_id', $listaprecio->localidad_id), ['class' => 'form-control']) }}
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
                                    <div class="form-group">
                                        <label for="precio">Precio:</label>
                                        <input type="text" class="form-control" name="precio" value="{{old('precio', $listaprecio->precio)}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
