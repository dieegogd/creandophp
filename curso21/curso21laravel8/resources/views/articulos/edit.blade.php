                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('categoria_id', App\Models\Categoria::orderBy('nombre')->pluck('nombre', 'id'), old('categoria_id', $articulo->categoria_id), ['class' => 'form-control']) }}
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
                                    <div class="form-group">
                                        <label for="unidadmedida_id">Unidad de Medida:</label>
                                        {{ Form::select('unidadmedida_id', App\Models\Unidadmedida::orderBy('nombre')->pluck('nombre', 'id'), old('unidadmedida_id', $articulo->unidadmedida_id), ['class' => 'form-control']) }}
                                    </div>
                                </div>
                            </div>
                            <div class="row">
